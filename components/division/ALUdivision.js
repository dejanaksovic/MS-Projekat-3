        ...
        if(this.iteration < quotient.length + 1){
            if(this.currStep == 0){
                ...
                if(rem < 0){
                    ...
                    returnValue[1] = (this.iteration + 1) + ":" + (this.currStep + 1) + " Jer je razlika Remainder i Divisor komponente negativna, Remainder ostaje isti."
                }else{
                    this.carryIn = '1'
                    returnValue[1] = (this.iteration + 1) + ":" + (this.currStep + 1) + " Remainder se promenio na novu vrednost."
                }
                ...
                if(this.carryIn == '1'){
                    returnValue[1] = (this.iteration + 1) + ":" + (this.currStep + 1) + " Quotient se pomera levo, uneseni bit je '1' jer je razlika Remainder i Divisor nenegativan broj."
                }else{
                    returnValue[1] = (this.iteration + 1) + ":" + (this.currStep + 1) + " Quotient se pomera levo, uneseni bit je '0' jer je razlika Remainder i Divisor negativan broj."
                }
                this.undoStack.push(['quotient', quotient])
            }else if(this.currStep == 2){
                returnValue[1] = (this.iteration + 1) + ":" + (this.currStep + 1) + " Divisor se pomera desno."
